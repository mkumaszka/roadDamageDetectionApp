...
from .model import tiny_yolo_body, yolo_body
from ..evaluation.model_output_evaluation import yolo_eval
...
class YOLO(object):
    _defaults = {
        ...
        "font_path": r'C:\Users\Martyna\PycharmProjects\roadDamageDetectionApp\backend\road_damages\yolo3\model\model_data\FiraMono-Medium.otf',
        "score": 0.3,
        "iou": 0.45,
    ...
    def mark_image_boxes(self, image, out_boxes, out_scores, out_classes, url):
