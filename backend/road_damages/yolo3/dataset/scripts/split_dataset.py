...
data_path = r"C:\Users\Martyna\Desktop\Studia\INZ\dane\RoadDamageDataset\test"
annos = "anno"
images = "img"

dir_anno_test = os.path.join(os.path.join(data_path, 'test'), 'anno')
dir_imgs_test = os.path.join(os.path.join(data_path, 'test'), 'img')
dir_anno_train = os.path.join(os.path.join(data_path, 'val'), 'anno')
dir_imgs_train = os.path.join(os.path.join(data_path, 'val'), 'img')
...
# for gov in govs:
#     gov_path = os.path.join(os.path.join(data_path, 'val'), 'img')
file_path = os.path.join(data_path, annos)
...
for file in file_list:
    if file == '.DS_Store' or '._' in file:
        ...
        dir_source_im = dir_source_im.replace('anno', 'img')
